...
namespace MarsFramework.Pages
{
    internal class ShareSkill
    {
        ...
        public void enterDetails()
        {
            ...
            foreach (IWebElement row in tableRow)
            {
                ...
                if (row.Text.Contains(Global.GlobalDefinitions.ExcelLib.ReadData(2, "Title")) && row.Text.Contains(Global.GlobalDefinitions.ExcelLib.ReadData(2, "Description")))
                {
                    ...
                    //GlobalDefinitions.test.Log(LogStatus.Pass, "Test Passed, Added a Language Successfully");
                    break;
                }
            }
        ...
        public void editShareSkillML()
        {
            ...
            string ele = Global.GlobalDefinitions.ExcelLib.ReadData(2, "OldTitle");
            string e2 = Global.GlobalDefinitions.ExcelLib.ReadData(2, "OldDescription");

            foreach (IWebElement row in tableRow)
            {
                var p = row.Text;
                if (row.Text.Contains(Global.GlobalDefinitions.ExcelLib.ReadData(2, "OldTitle")) && row.Text.Contains(Global.GlobalDefinitions.ExcelLib.ReadData(2, "OldDescription")))
                {
                    var editLink = GlobalDefinitions.driver.FindElement(By.XPath("//td[text()='"+ Global.GlobalDefinitions.ExcelLib.ReadData(2, "OldTitle") +"']/..//td/i[2]"));
                    editLink.Click();
